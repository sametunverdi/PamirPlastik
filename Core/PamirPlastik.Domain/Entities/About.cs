...
namespace PamirPlastik.Domain.Entities
{
    public class About
    {
        ...
        // --- SEO BÖLÜMÜ ---
        // HTML'deki: ViewData["Title"] ve ViewData["Description"] kısımları
        ...
        // --- HERO BÖLÜMÜ (En üstteki yazılar) ---
        // HTML'deki: "1990'dan Bugüne, Her Enjeksiyonda Aynı Tutku."
        public string MainTitle_TR { get; set; }
        public string MainTitle_EN { get; set; }

        // HTML'deki: "Küçük bir atölyeden, dünyaya açılan entegre tesislere..."
        public string SubTitle_TR { get; set; }
        public string SubTitle_EN { get; set; }

        // HTML'deki: "Pamir Plastik olarak yolculuğumuz..." diye başlayan uzun metinler
        ...
        // HTML'deki: Sarı kutu içindeki "Sadece plastik üretmiyoruz..." yazısı
        public string HighlightQuote_TR { get; set; }
        public string HighlightQuote_EN { get; set; }

        // --- VİZYON VE MİSYON BÖLÜMÜ ---
        // HTML'deki: "Gelecek Vizyonu" ve "Temel Misyon" alanları
