...
{
    public class GetHomePageSettingQueryHandler : IRequestHandler<GetHomePageSettingQuery, List<GetHomePageSettingQueryResult>>
    {
        private readonly IRepository<HomePageSetting> _repository;

        public GetHomePageSettingQueryHandler(IRepository<HomePageSetting> repository)
        {
            _repository = repository;
        }

        public async Task<List<GetHomePageSettingQueryResult>> Handle(GetHomePageSettingQuery request, CancellationToken cancellationToken)
        {
            var values = await _repository.GetAllAsync();
            return values.Select(value => new GetHomePageSettingQueryResult
            {
