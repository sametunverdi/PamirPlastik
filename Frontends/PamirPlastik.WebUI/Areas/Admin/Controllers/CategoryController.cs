...
namespace PamirPlastik.WebUI.Areas.Admin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> Create(CreateCategoryDto createCategoryDto)
        {
            ...
            {
                createCategoryDto.Slug = createCategoryDto.Name_TR.ToLower().Replace(" ", "-").Replace("ı", "i").Replace("ğ", "g").Replace("ü", "u").Replace("ş", "s").Replace("ö", "o").Replace("ç", "c");
            }
            ...
            TempData["ErrorMessage"] = "Kategori kayıt edilemedi. Lütfen zorunlu alanları kontrol edin.";
        ...
        public async Task<IActionResult> Edit(UpdateCategoryDto updateCategoryDto)
        {
            ...
            {
                updateCategoryDto.Slug = updateCategoryDto.Name_TR.ToLower().Replace(" ", "-").Replace("ı", "i").Replace("ğ", "g").Replace("ü", "u").Replace("ş", "s").Replace("ö", "o").Replace("ç", "c");
            }
            ...
            TempData["ErrorMessage"] = "Kategori güncellenemedi. Lütfen alanları kontrol edin.";
        ...
        public async Task<IActionResult> DeleteCategory(int id)
        {
            ...
            return Json(new { success = false, message = "Kategori silinemedi. Lütfen önce bu kategoriye bağlı ürünleri silin veya kategorilerini değiştirin." });
        }
    }
}
